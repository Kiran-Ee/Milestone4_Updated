...
public class BneTest {
    ...
    public void branchHandler_bne1() {
        ...
        int pc1 = 10;
        int exp_pc1 = pc1;
        assertEquals(exp_pc1, branch_handler(bne,pc1));
    }
    ...
    public void branchHandler_bne2() {
        ...
        int pc2 = 30000;
        int exp_pc2 = pc2 + 1 + 0;
        assertEquals(exp_pc2, branch_handler(bne,pc2));
    }
    ...
    public void branchHandler_bne3() {
        ...
        int pc3 = 0;
        int exp_pc3 = pc3;
        assertEquals(exp_pc3, branch_handler(bne,pc3));
    }
    ...
    public void branchHandler_bne4() {
        ...
        int pc4 = 10;
        int exp_pc4 = pc4 + 1 - 5;
        assertEquals(exp_pc4, branch_handler(bne,pc4));
    }
}
